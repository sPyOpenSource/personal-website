        ...
        return (
          <footer className="container">
            <p>
              ...
              <a href="https://twitter.com/xuyi_wang"><img className="avatar" alt="Twitter" src="img/social_network_icons/twitter.png"/></a>
              <a href="https://soundcloud.com/xuyi-wang"><img className="avatar" alt="SoundCload" src="img/social_network_icons/soundcload.png"/></a>
            </p>
